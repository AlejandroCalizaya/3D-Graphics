...
int main() {
    ...
    GLFWwindow *window =
        glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Iluminacion: Phong [B para cambiar]", nullptr, nullptr);
    if (!window) {
        glfwTerminate();
        return -1;
    }
    ...
    unsigned char *data = stbi_load("texture/world.jpg", &imageWidth, &imageHeight, &imageChannels, STBI_rgb_alpha);
    if (data) {
